        ...
        <div class="container py-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-lg-auto me-lg-3 mt-3 mt-lg-0 gap-lg-1">
                    ...
                    @if (!empty($navProdi) && $navProdi->count())
                        <li class="nav-item dropdown">
                            ...
                            <div
                                ...
                                @php
                                    // Kalau route pakai model binding {programStudi:slug}
                                ...
                                <div class="p-3">
                                    ...
                                    @foreach ($groups as $items)
                                        ...
                                        @foreach ($items as $item)
                                            ...
                                            <a class="dropdown-item d-flex align-items-center justify-content-between mb-2 {{ $isActive ? 'active' : '' }}"
                                                href="{{ $href }}"
